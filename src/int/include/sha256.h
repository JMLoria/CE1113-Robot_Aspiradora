...
/*
 * @brief Implementacion ligera de SHA-256 para sistemas embebidos.
 * Basado en el estandar FIPS 180-4
*/
class SHA256 {
public:
    static std::string hash(const std::string& input) {
        ...
        // Añadir longitud original al final (64-bit big-endian)
        for (int i = 7; i >= 0; i--) {
            message.push_back(static_cast<uint8_t>(bit_len >> (i * 8)));
        }

        // Procesar por bloques de 512 bits
